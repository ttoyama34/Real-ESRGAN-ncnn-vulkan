...
#if _WIN32
int webp_save(const wchar_t* filepath, int w, int h, int c, int quality, const unsigned char* pixeldata)
#else
int webp_save(const char* filepath, int w, int h, int c, int quality, const unsigned char* pixeldata)
#endif
{
    int ret = 0;
